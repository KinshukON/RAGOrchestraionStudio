...
// ── Nav structure: 4 commercial sections ──────────────────────────────
interface NavItem { to: string; label: string; d: string; end?: boolean }
interface NavGroup { section: string; items: NavItem[]; adminOnly?: boolean }
...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { to: '/app/industry-packs',  end: false, label: 'Industry Packs',  d: 'M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z' },
    ],
  },
  {
    section: 'Operate',
    items: [
      { to: '/app/executive-summary', end: false, label: 'Executive Summary', d: 'M3 3a1 1 0 000 2h11a1 1 0 100-2H3zm0 4a1 1 0 000 2h7a1 1 0 100-2H3zm0 4a1 1 0 100 2h4a1 1 0 100-2H3zm12-1a1 1 0 011 1v3.586l1.293-1.293a1 1 0 011.414 1.414l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 011.414-1.414L15 14.586V11a1 1 0 011-1z' },
      ...
      { to: '/app/cost-roi',      end: false, label: 'Cost & ROI',   d: 'M8.433 7.418c.155-.103.346-.196.567-.267v1.698a2.305 2.305 0 01-.567-.267C8.07 8.34 8 8.114 8 8c0-.114.07-.34.433-.582zM11 12.849v-1.698c.22.071.412.164.567.267.364.243.433.468.433.582 0 .114-.07.34-.433.582a2.305 2.305 0 01-.567.267zm4-4.849a.75.75 0 01.75.75v.5a.75.75 0 01-1.5 0v-.5A.75.75 0 0115 8zm-9.75.75A.75.75 0 014.5 8h.5a.75.75 0 010 1.5H4.5a.75.75 0 01-.75-.75zM10 4a6 6 0 100 12A6 6 0 0010 4zm-8 6a8 8 0 1116 0A8 8 0 012 10z' },
    ],
  },
  {
    section: 'Control',
      ...
      <aside className={sidebarClass}>
        ...
        <nav className="shell-nav">
          {NAV_GROUPS.map(group => (
            <div key={group.section} className="shell-nav-group">
              {!collapsed && (
